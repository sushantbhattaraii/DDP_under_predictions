...
files = sorted(glob.glob('./results/yes_constraints/1024/overlap50/1024nodes_diameter*.xlsx'))
...
ax3.set_title(f'Stretch vs Fraction of Predicted Nodes (Overlap: {overlap_value}%)')
ax3.legend(loc='best')
# ax2.grid(True)
